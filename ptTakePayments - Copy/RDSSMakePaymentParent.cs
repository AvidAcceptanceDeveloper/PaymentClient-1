...
namespace RDDSMakePayments
{
    ...
    public partial class RDSSMakePaymentParent : Form
    {
        ...
        {
            System.Drawing.Image greenimg = RDDSMakePayments.Properties.Resources.blank_green_icon;
            System.Drawing.Image yellowimg = RDDSMakePayments.Properties.Resources.blank_yellow_icon;
            string[] sRetCode = null;

            RDSSNLSMPUtilsClasses.cSettings oSettings = new RDSSNLSMPUtilsClasses.cSettings(RDDSMakePayments.Properties.Settings.Default.SettingsFile);
            
            RDSSNLSMPUtilsClasses.cNortridgeWapper nls = new RDSSNLSMPUtilsClasses.cNortridgeWapper();
            sRetCode = nls.VerifyACH(oSettings.MPAccount.ToString(), float.Parse("0.00"), rtxtABANumber.Text, "9999999", "NONE", "0", "NA");
            if (sRetCode[0].ToString()=="DECLINED")
            {
                picVerifABA.Image = yellowimg;
            }
            else
            {
                picVerifABA.Image = greenimg;
            }
        }
