...
namespace RDSSNLSMPUtilsClasses
{
    public class cNortridgeWapper
    {
        ...
        public string PayByACHNacha(string sLoanNumber, string sCompanyId, string abanumber, string checkingaccountnumber,
             string paymentamount, string achfeeamt, string paymentreference, string transuserid, string IncludeFees, string MPResults, DateTime PayDate, string sCustomerEmail,string accountType)
        {
            ...
            sb.Append("<ACH ACHCompanyID ='" + sCompanyId + "' Status='0' ABANumber ='" + abanumber +
                ...
                "' MaximumAmountOfDraws='1' BillingType='1' AccountType = '" + accountType + "' BillingStartDate='" + PayDate.ToShortDateString() + "' Description='" + sReference + "' OptionFlags='2' />");
            sb.Append("</LOAN></NLS>");
